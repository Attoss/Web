...
module.exports = 
{
  ...
  create: function(req, res){
    //insert into asiakas (nimi, osoite, postinro, postitmp, luontipvm, asty_avain) values ('Kuolio', 'Katu 3', '70100', 'Kuopio', curdate(), '2');
    //var sql ="INSERT INTO asiakas (nimi, osoite, postinro, postitmp, luontipvm, asty_avain) VALUES ("+"'"+JSON.stringify(req.body.nimi)+"','" +JSON.stringify(req.body.osoite)+"','"+JSON.stringify(req.body.postinro)+"','"+JSON.stringify(req.body.postitmp)+"',"+"curdate()"+",'"+JSON.stringify(req.body.asty_avain)+"')";
    console.log(JSON.stringify(req.body));
    
    connection.query('INSERT INTO asiakas (nimi, osoite, postinro, postitmp, luontipvm, asty_avain) VALUES ("'+req.body.nimi+'", "'+req.body.osoite+'", "'+req.body.postinro+'", "'+req.body.postitmp+'",'+"curdate()"+',"'+req.body.asty_avain+'")', function(error, results, fields){
